...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div id="main_content">
    ...
    <div class="center_content">
      <div class="center_title_bar" data-aos="fade-right">Hasil Diagnosa</div>
      <div class="prod_box_big">
        <div class="center_prod_box_big" >
				<table width="100%" >
				 ...
				 <div data-aos="fade-up">
				 	<button onclick="location.href='hasil_pasien.php?id=<?php echo $data_hasildiagnosa['kd_penyakit'];?>&id2=<?php echo $data_pasien['id'];?>'" class="btn btn-success" >Simpan Hasil</button> <button onclick="location.href='diagnosa.php'" class="btn btn-warning" >Ulangi Diagnosa</button> 
					</div>
        </div>
      </div>
    </div>
