    ...
    function delete_data(id)
     {
       if(confirm('Anda Yakin Menghapus Data Dengan No ID : '+id+' ?'))
         {
          window.location.href='delete_gejala.php?delete_id='+id;
         }
     }
</script>
</head>
                ...
                <div class="panel panel-default">
                     <div class="panel-body">
                         <div class="table-responsive">                            
							 Tambah Data Gejala :&nbsp;<a href="add_gejala.php"><img src="assets/img/add.png" width="20"></br></br></a> 
                             <table class="table table-striped table-bordered table-hover" >
                                 <thead>
                                    <tr>
                                      <th width="4%"><div align="center">No</div></th>
                                      <th width="10%"><div align="center">Kode Gejala</div></th>
                                      <th width="78%"><div align="center">Nama Gejala</div></th>
                                  ...
                                  <?php
									  ...
									  $total_data  = "SELECT COUNT(*) AS jumData FROM `gejala` ORDER BY `kd_gejala`";
                                      $query = "SELECT * FROM `gejala` ORDER BY `kd_gejala` LIMIT $offset, $dataPerPage";
									...
									?>
                                     <tr>
									   ...
									   <td><div align="center"><?php echo $data['kd_gejala'] ?></div></td>
									   <td><?php echo $data['nm_gejala'] ?></td>
                                       <td align="center">
                                        <a href="edit_gejala.php?id=<?php echo $data['id_gejala'] ?>">
                                        <img src="assets/img/edit.png" width="20"></a>&nbsp;
                                        <a href="javascript:delete_data(<?php echo $data['id_gejala'] ?>)">
