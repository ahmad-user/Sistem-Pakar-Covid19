  ...
  <div id="wrap">
    ...
    <div id="left">
      ...
      <ul id="menu" class="collapse">                
        ...
        <li><a href="laporan_penyakit.php"><i class="icon-film"></i>&nbsp;Laporan Data Pasien&nbsp;</a></li>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                <form role="form" method="post" action="tambah_relasi.php">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" placeholder="Enter text" name="kdgejala">
                                    </div>                                      
