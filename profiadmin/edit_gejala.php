      ...
      <ul id="menu" class="collapse">                
       ...
       <div id="content">
          <div class="inner">
             <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">KELOLA DATA GEJALA</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                 <?php
								  $query = "SELECT * FROM `gejala` WHERE `id_gejala` = '".$_REQUEST['id']."' ORDER BY `id_gejala`";
								  $result = mysqli_query($koneksi,$query); //execute the query $query 
	                              $data = mysqli_fetch_array($result)
								?>
                                <form role="form" method="post" action="ubah_gejala.php?id=<?php echo $data['id_gejala']?>">
                                    ...
                                    <div class="form-group">
                                        <label>Kode Gejala</label>
                                        <input class="form-control" value="<?php echo $data['nm_gejala']?>" name="nmgejala">
                                    </div>
