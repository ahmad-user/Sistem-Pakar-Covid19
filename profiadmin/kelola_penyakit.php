    ...
    function delete_data(id)
     {
       if(confirm('Anda Yakin Menghapus Data Dengan No ID : '+id+' ?'))
         {
          window.location.href='delete_penyakit.php?delete_id='+id;
         }
     }
</script>
</head>
                ...
                <div class="panel panel-default">
                     <div class="panel-body">
                         <div class="table-responsive">                            
							 Tambah Data Penyakit :&nbsp;<a href="add_penyakit.php"><img src="assets/img/add.png" width="20"></br></br></a> 
                             <table class="table table-striped table-bordered table-hover" >
                                 <thead>
                                    <tr>
                                      <th width="4%"><div align="center">No</div></th>
                                      <th width="10%"><div align="center">Kode Penyakit</div></th>
                                      <th width="15%"><div align="center">Nama Penyakit</div></th>
                                      <th width="25%"><div align="center">Defenisi</div></th>
                                      <th width="38%"><div align="center">Penanganan</div></th>
                                  ...
                                  <?php
									  ...
									  $total_data  = "SELECT COUNT(*) AS jumData FROM `penyakit` ORDER BY `kd_penyakit`";
                                      $query = "SELECT * FROM `penyakit` ORDER BY `kd_penyakit` LIMIT $offset, $dataPerPage";
									...
									?>
                                     <tr>
                                       ...
                                       <td align="center">
                                        <a href="edit_penyakit.php?id=<?php echo $data['id_penyakit'] ?>">
                                        <img src="assets/img/edit.png" width="20"></a>&nbsp;
                                        <a href="javascript:delete_data(<?php echo $data['id_penyakit'] ?>)">
