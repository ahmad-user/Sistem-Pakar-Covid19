                ...
                <div class="panel panel-default">
                     <div class="panel-body">
                         <div class="table-responsive">                            
							 Tambah Data Pengguna :&nbsp;<a href="add_user.php"><img src="assets/img/add.png" width="20"></br></br></a> 
                             <table class="table table-striped table-bordered table-hover" >
                                 <thead>
                                    <tr>
                                      <th width="4%"><div align="center">No</div></th>
                                      <th width="10%"><div align="center">Username</div></th>
                                      <th width="12%"><div align="center">Password</div></th>
                                      <th width="68%"><div align="center">Nama Lengkap</div></th>
                                  ...
                                  <?php
									  ...
									  $total_data  = "SELECT COUNT(*) AS jumData FROM `user` ORDER BY `id`";
                                      $query = "SELECT * FROM `user` ORDER BY `id` LIMIT $offset, $dataPerPage";
									...
									?>
                                     <tr>
                                       ...
                                       <td align="center">
                                        ...
                                        <a href="javascript:delete_data(<?php echo $data['id'] ?>)">
