  ...
  <div id="wrap">
    ...
    <div id="left">
      ...
      <ul id="menu" class="collapse">                
        ...
        <li><a href="klaporan_pasien.php"><i class="icon-film"></i>&nbsp;Laporan Data Pasien&nbsp;</a></li>
       ...
       <div id="content">
          <div class="inner">
             <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">KELOLA DATA RELASI GEJALA - PENYAKIT</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                 <?php
								  $query = "SELECT * FROM `relasi` WHERE `id_relasi` = '".$_REQUEST['id']."' ORDER BY `id_relasi`";
								  $result = mysqli_query($koneksi,$query); //execute the query $query 
	                              $data = mysqli_fetch_array($result)
								?>
                                <form role="form" method="post" action="ubah_relasi.php?id=<?php echo $data['id_relasi']?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="<?php echo $data['kd_gejala']?>" name="kdgejala">
                                    </div>
