                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                <form role="form" action="tambah_penyakit.php" method="post">
									<div class="form-group">
                                        <label>Kode Peyakit</label>
                                        <input class="form-control" placeholder="Enter text" name="kdpenyakit">
                                    </div>  
                                    <div class="form-group">
                                        <label>Nama Penyakit</label>
                                        <input class="form-control" placeholder="Enter text" name="nmpenyakit">
                                    </div>                                 
                                    <div class="form-group">
                                        <label>Definisi Penyakit</label>
                                        <textarea class="form-control" rows="4" name="defenisi"></textarea>
                                    </div>                                       
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="4" name="solusi"></textarea>
                                    </div>
                                    <div class="form-group">
                                         <label>Uraian Penyakit</label>
                                        <textarea class="form-control" rows="4" name="uraian"></textarea>
                                    </div>
                                  </form>                                    
                                </div>                             
                             </div>
