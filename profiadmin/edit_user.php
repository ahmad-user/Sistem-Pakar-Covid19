                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                 <?php
								  $query = "SELECT * FROM `user` WHERE `id` = '".$_REQUEST['id']."' ORDER BY `id`";
								  $result = mysqli_query($koneksi,$query); //execute the query $query 
	                              $data = mysqli_fetch_array($result)
								?>
                                <form role="form" method="post" action="ubah_user.php?id=<?php echo $data['id']?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="<?php echo $data['password']?>" name="password">
                                    </div>      
									<div class="form-group">
