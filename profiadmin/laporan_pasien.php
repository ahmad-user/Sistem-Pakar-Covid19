                             ...
                             <table class="table table-striped table-bordered table-hover" >
                                 <thead>
                                    <tr>
                                      ...
                                      <th width="16%"><div align="center">Nama</div></th>
                                      <th width="32%"><div align="center">Alamat</div></th>
                                      <th width="7%"><div align="center">Kelamin</div></th>
                                      <th width="12%"><div align="center">Pekerjaan</div></th>
                                      <th width="10%"><div align="center">No Telepone</div></th>
                                  ...
                                  <?php
									  ...
									  $total_data  = "SELECT COUNT(*) AS jumData FROM `pasien` ORDER BY `id`";
                                      $query = "SELECT * FROM `pasien` ORDER BY `id` LIMIT $offset, $dataPerPage";
                                     ...
                                     <?php
									  ...
									  <tr>									  
                                       <td align="right" colspan="7">
                                        <a href="cetak_pasien.php"><img src="assets/img/print.png" width="20"></a>
                                       </td>									  	
									  </tr>
                                        <tr>
											<td colspan="11">
